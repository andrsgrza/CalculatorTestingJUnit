...
private Calculator cobj = new Calculator();
	...
	void assertDelayInValidTest() {
		Executable execution = () -> cobj.delay(2); // Delay for 2 seconds
		assertTimeout(Duration.ofSeconds(3)/*Duration.ofNanos(3)*/, execution); // Timeout after 3 nanoseconds
	}
	...
	void preemptiveAssertDelayInValidTest() {
		Executable execution = () -> cobj.delay(2); // Delay for 2 seconds
		assertTimeoutPreemptively(Duration.of(300000000, ChronoUnit.DAYS), execution); // Timeout after 3 nanoseconds
	}
}
